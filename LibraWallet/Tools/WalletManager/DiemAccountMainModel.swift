...
struct DiemErrorStatusCode: Codable {
    var StatusCode: Int?
}
struct DiemErrorDataModel: Codable {
    var code: Int?
    var data: DiemErrorStatusCode?
    var message: String?
}
struct DiemRoleDataModel: Codable {
    // 通用
...
struct DiemAccountInfoDataModel: Codable {
    ...
    var role: DiemRoleDataModel
}
struct DiemAccountMainModel: Codable {
    ...
    var jsonrpc: String?
    /// 数据体
    var result: DiemAccountInfoDataModel?
    /// 错误
    var error: DiemErrorDataModel?
}
