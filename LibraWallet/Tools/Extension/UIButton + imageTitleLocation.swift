//
//  UIButton + imageTitleLocation.swift
//  SSO
//
//  Created by palliums on 2019/12/2.
...
extension UIButton {
    func imagePosition(at style: ZGJButtonImageEdgeInsetsStyle, space: CGFloat, imageViewSize: CGSize) {
...
//        let imageHeight = imageV.frame.size.height
        ...
        let imageHeight = imageViewSize.height
        //获取文字的宽和高
