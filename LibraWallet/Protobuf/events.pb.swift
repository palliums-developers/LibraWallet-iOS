...
struct Types_EventWithProof {
  ...
  mutating func clearEvent() {_storage._event = nil}
...
extension Types_Event: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Types_Event) -> Bool {
    if self.key != other.key {return false}
    if self.sequenceNumber != other.sequenceNumber {return false}
    if self.eventData != other.eventData {return false}
...
extension Types_EventWithProof: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Types_EventWithProof) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
        if _storage._transactionVersion != other_storage._transactionVersion {return false}
        if _storage._eventIndex != other_storage._eventIndex {return false}
...
extension Types_EventsList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Types_EventsList) -> Bool {
...
extension Types_EventsForVersions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Types_EventsForVersions) -> Bool {
    if self.eventsForVersion != other.eventsForVersion {return false}
    if unknownFields != other.unknownFields {return false}
    return true
  }
}
