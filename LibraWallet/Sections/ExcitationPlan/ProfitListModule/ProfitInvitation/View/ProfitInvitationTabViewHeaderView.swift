//
//  ProfitInvitationTabViewHeaderView.swift
//  LibraWallet
//
...
class ProfitInvitationTabViewHeaderView: UITableViewHeaderFooterView {
    ...
    deinit {
        print("ProfitInvitationTabViewHeaderView销毁了")
    }
    // MARK: - 布局
    ...
    lazy var itemAddressTitleLabel: UILabel = {
        ...
        label.text = localLanguage(keyString: "wallet_profit_invitation_address_title")
        return label
    }()
    lazy var itemAmountTitleLabel: UILabel = {
        ...
        label.textColor = UIColor.init(hex: "999999")
        label.font = UIFont.systemFont(ofSize: adaptFont(fontSize: 10), weight: UIFont.Weight.regular)
        label.text = localLanguage(keyString: "wallet_profit_invitation_amount_title")
        return label
    }()
    lazy var itemDateTitleLabel: UILabel = {
        ...
        label.textColor = UIColor.init(hex: "999999")
        label.font = UIFont.systemFont(ofSize: adaptFont(fontSize: 10), weight: UIFont.Weight.regular)
        label.text = localLanguage(keyString: "wallet_profit_invitation_date_title")
        return label
    }()
