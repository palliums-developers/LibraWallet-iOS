...
class TransactionHistoryTableViewCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        self.amountLabel.snp.makeConstraints { (make) in
            make.centerY.equalTo(self.dateLabel).offset(-1)
            make.right.equalTo(self.detailIndicatorImageView.snp.left).offset(-10)
        }
    ...
    var model: Transaction? {
        didSet {
            ...
            amountLabel.text = amountState + (tempModel.amount ?? "")
