...
class ScanSwapView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        whiteBackgroundView.addSubview(outputAmountTitleLabel)
        whiteBackgroundView.addSubview(outputAmountLabel)
    ...
    override func layoutSubviews() {
        ...
        outputAmountTitleLabel.snp.makeConstraints { (make) in
            make.top.equalTo(inputAmountLabel.snp.bottom).offset(16)
            make.left.equalTo(whiteBackgroundView).offset(14)
        }
        outputAmountLabel.snp.makeConstraints { (make) in
            make.top.equalTo(outputAmountTitleLabel.snp.bottom).offset(8)
            make.left.equalTo(whiteBackgroundView).offset(14)
            make.right.equalTo(whiteBackgroundView.snp.right).offset(-14)
        }
        spaceLabel.snp.makeConstraints { (make) in
            make.top.equalTo(whiteBackgroundView).offset(136)
            make.left.equalTo(whiteBackgroundView).offset(14)
            make.right.equalTo(whiteBackgroundView.snp.right).offset(-14)
