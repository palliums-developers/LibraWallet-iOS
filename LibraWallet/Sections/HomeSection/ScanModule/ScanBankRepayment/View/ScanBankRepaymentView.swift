...
class ScanBankRepaymentView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        bottomWhiteBackgroundView.addSubview(loanRateTitleLabel)
        bottomWhiteBackgroundView.addSubview(loanRateLabel)
        bottomWhiteBackgroundView.addSubview(minerFeesTitleLabel)
        bottomWhiteBackgroundView.addSubview(minerFeesLabel)
        bottomWhiteBackgroundView.addSubview(repaymentTotalAmountTitleLabel)
        bottomWhiteBackgroundView.addSubview(repaymentTotalAmountLabel)
        bottomWhiteBackgroundView.addSubview(repaymentWaysTitleLabel)
        bottomWhiteBackgroundView.addSubview(repaymentWaysLabel)
    ...
    deinit {
        print("ScanBankRepaymentView销毁了")
    }
    //MARK: - 布局
    override func layoutSubviews() {
        ...
        loanRateTitleLabel.snp.makeConstraints { (make) in
            make.top.equalTo(bottomWhiteBackgroundView).offset(10)
            make.left.equalTo(bottomWhiteBackgroundView).offset(34)
            make.height.equalTo(31)
        }
        loanRateLabel.snp.makeConstraints { (make) in
            make.centerY.equalTo(loanRateTitleLabel)
        ...
        minerFeesTitleLabel.snp.makeConstraints { (make) in
            make.top.equalTo(loanRateTitleLabel.snp.bottom).offset(5)
            make.left.equalTo(bottomWhiteBackgroundView).offset(34)
            make.height.equalTo(31)
        }
        ...
        repaymentTotalAmountTitleLabel.snp.makeConstraints { (make) in
            make.top.equalTo(minerFeesTitleLabel.snp.bottom).offset(5)
            make.left.equalTo(bottomWhiteBackgroundView).offset(34)
            make.height.equalTo(31)
        }
        repaymentTotalAmountLabel.snp.makeConstraints { (make) in
            make.centerY.equalTo(repaymentTotalAmountTitleLabel)
            make.left.equalTo(bottomWhiteBackgroundView).offset(130)
            make.right.equalTo(bottomWhiteBackgroundView.snp.right).offset(-14)
        }
        repaymentWaysTitleLabel.snp.makeConstraints { (make) in
            make.top.equalTo(repaymentTotalAmountTitleLabel.snp.bottom).offset(5)
            make.left.equalTo(bottomWhiteBackgroundView).offset(34)
            make.height.equalTo(31)
        }
        repaymentWaysLabel.snp.makeConstraints { (make) in
            make.centerY.equalTo(repaymentWaysTitleLabel)
            make.left.equalTo(bottomWhiteBackgroundView).offset(130)
            make.right.equalTo(bottomWhiteBackgroundView.snp.right).offset(-14)
        }
    ...
    lazy var scanLoginTitleLabel: UILabel = {
        ...
        label.text = localLanguage(keyString: "wallet_wallet_connect_bank_repayment_title")
...
//        label.font = UIFont.systemFont(ofSize: 16, weight: .regular)
    ...
    lazy var loanRateTitleLabel: UILabel = {
        let label = UILabel.init()
        label.textAlignment = NSTextAlignment.right
        label.textColor = UIColor.init(hex: "999999")
        label.font = UIFont.systemFont(ofSize: 12, weight: .regular)
        label.text = localLanguage(keyString: "wallet_bank_repayment_loan_interest_title")
        label.numberOfLines = 0
        return label
    }()
    lazy var loanRateLabel: UILabel = {
        let label = UILabel.init()
        label.textAlignment = NSTextAlignment.left
        label.textColor = UIColor.init(hex: "333333")
//        label.font = UIFont.systemFont(ofSize: 12, weight: .regular)
...
//        label.font = UIFont.systemFont(ofSize: 12, weight: .regular)
    ...
    lazy var repaymentTotalAmountTitleLabel: UILabel = {
        let label = UILabel.init()
        label.textAlignment = NSTextAlignment.left
        label.textColor = UIColor.init(hex: "999999")
        label.font = UIFont.systemFont(ofSize: 12, weight: .regular)
        label.text = localLanguage(keyString: "wallet_bank_repayment_repayment_total_amount_title")
        label.numberOfLines = 0
        return label
    }()
    lazy var repaymentTotalAmountLabel: UILabel = {
        let label = UILabel.init()
        label.textAlignment = NSTextAlignment.left
        label.textColor = UIColor.init(hex: "333333")
//        label.font = UIFont.systemFont(ofSize: 12, weight: .regular)
    ...
    lazy var repaymentWaysTitleLabel: UILabel = {
        let label = UILabel.init()
        label.textAlignment = NSTextAlignment.left
        label.textColor = UIColor.init(hex: "999999")
        label.font = UIFont.systemFont(ofSize: 12, weight: .regular)
        label.text = localLanguage(keyString: "wallet_bank_repayment_pay_account_title")
        label.numberOfLines = 0
        return label
    }()
    lazy var repaymentWaysLabel: UILabel = {
        let label = UILabel.init()
        label.textAlignment = NSTextAlignment.left
        label.textColor = UIColor.init(hex: "333333")
        label.font = UIFont.systemFont(ofSize: 12, weight: .regular)
        label.text = localLanguage(keyString: "wallet_bank_repayment_pay_account_content")
        label.numberOfLines = 0
        return label
    }()
