...
class ScanBankDepositView: UIView {
    ...
    override func layoutSubviews() {
        ...
        depositRateTitleLabel.snp.makeConstraints { (make) in
            ...
            make.left.equalTo(bottomWhiteBackgroundView).offset(14)
...
//        label.font = UIFont.systemFont(ofSize: 16, weight: .regular)
    ...
    lazy var depositRateTitleLabel: UILabel = {
        ...
        label.text = localLanguage(keyString: "wallet_bank_deposit_year_rate_title")
        label.numberOfLines = 0
        return label
    }()
...
//        label.font = UIFont.systemFont(ofSize: 14, weight: .regular)
    ...
    lazy var depositWaysTitleLabel: UILabel = {
        ...
        label.textColor = UIColor.init(hex: "999999")
        label.font = UIFont.systemFont(ofSize: 12, weight: .regular)
        label.text = localLanguage(keyString: "wallet_bank_deposit_pay_account_title")
        label.numberOfLines = 0
        return label
    }()
    lazy var depositWaysLabel: UILabel = {
        ...
        label.textColor = UIColor.init(hex: "333333")
        label.font = UIFont.systemFont(ofSize: 12, weight: .regular)
        label.text = localLanguage(keyString: "wallet_bank_deposit_pay_account_content")
        label.numberOfLines = 0
        return label
    }()
