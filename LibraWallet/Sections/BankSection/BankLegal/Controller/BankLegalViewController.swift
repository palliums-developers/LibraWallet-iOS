...
class BankLegalViewController: BaseViewController {
    ...
    deinit {
        print("BankLegalViewController销毁了")
    }
    override func back() {
        self.dismiss(animated: true, completion: nil)
    }
    //子View
    private lazy var detailView : BankLegalView = {
        let view = BankLegalView.init()
        view.webView.navigationDelegate = self
        return view
    }()
    var needDismissViewController: Bool?
}
extension BankLegalViewController :WKNavigationDelegate{
    // 页面开始加载时调用
