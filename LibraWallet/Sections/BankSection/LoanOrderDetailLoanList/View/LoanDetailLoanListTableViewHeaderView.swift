//
//  LoanDetailLoanListTableViewHeaderView.swift
//  LibraWallet
//
...
class LoanDetailLoanListTableViewHeaderView: UITableViewHeaderFooterView {
    ...
    deinit {
        print("LoanDetailLoanListTableViewHeaderView销毁了")
    }
    //MARK: - 布局
