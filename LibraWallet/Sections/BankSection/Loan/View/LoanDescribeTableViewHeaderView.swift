//
//  LoanDescribeTableViewHeaderView.swift
//  LibraWallet
//
...
import UIKit
protocol LoanDescribeTableViewHeaderViewDelegate: NSObjectProtocol {
    func showQuestions(header: LoanDescribeTableViewHeaderView)
}
class LoanDescribeTableViewHeaderView: UITableViewHeaderFooterView {
    weak var delegate: LoanDescribeTableViewHeaderViewDelegate?
    ...
    deinit {
        print("LoanDescribeTableViewHeaderView销毁了")
    }
    //pragma MARK: 布局
    ...
    private lazy var itemIndicatorImageView : UIImageView = {
        ...
        imageView.image = UIImage.init(named: "wallet_bank_loan_describe_title")
        return imageView
    }()
