//
//  AssetsPoolTransactionDetailFooterView.swift
//  LibraWallet
//
...
class AssetsPoolTransactionDetailFooterView: UITableViewHeaderFooterView {
    ...
    deinit {
        print("AssetsPoolTransactionDetailFooterView销毁了")
    }
    //pragma MARK: 布局
