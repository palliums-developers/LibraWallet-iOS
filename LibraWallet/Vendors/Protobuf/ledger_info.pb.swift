...
struct Types_LedgerInfo {
  ...
  var epochNum: UInt64 {
    get {return _storage._epochNum}
    set {_uniqueStorage()._epochNum = newValue}
  }
  ...
  mutating func clearNextValidatorSet() {_storage._nextValidatorSet = nil}
...
extension Types_LedgerInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    7: .standard(proto: "next_validator_set"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 5: try decoder.decodeSingularUInt64Field(value: &_storage._epochNum)
        case 6: try decoder.decodeSingularUInt64Field(value: &_storage._timestampUsecs)
        case 7: try decoder.decodeSingularMessageField(value: &_storage._nextValidatorSet)
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._epochNum != 0 {
        try visitor.visitSingularUInt64Field(value: _storage._epochNum, fieldNumber: 5)
      }
  ...
  func _protobuf_generated_isEqualTo(other: Types_LedgerInfo) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._transactionAccumulatorHash != other_storage._transactionAccumulatorHash {return false}
        if _storage._consensusDataHash != other_storage._consensusDataHash {return false}
        if _storage._consensusBlockID != other_storage._consensusBlockID {return false}
        if _storage._epochNum != other_storage._epochNum {return false}
        if _storage._timestampUsecs != other_storage._timestampUsecs {return false}
        if _storage._nextValidatorSet != other_storage._nextValidatorSet {return false}
        return true
      }
