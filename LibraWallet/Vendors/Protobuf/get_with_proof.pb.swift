...
struct Types_UpdateToLatestLedgerResponse {
  ...
  var validatorChangeEvents: Types_ValidatorChangeEventWithProof {
    get {return _storage._validatorChangeEvents ?? Types_ValidatorChangeEventWithProof()}
    set {_uniqueStorage()._validatorChangeEvents = newValue}
  }
  /// Returns true if `validatorChangeEvents` has been explicitly set.
  var hasValidatorChangeEvents: Bool {return _storage._validatorChangeEvents != nil}
  /// Clears the value of `validatorChangeEvents`. Subsequent reads from it will return its default value.
  mutating func clearValidatorChangeEvents() {_uniqueStorage()._validatorChangeEvents = nil}
...
extension Types_UpdateToLatestLedgerResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _validatorChangeEvents: Types_ValidatorChangeEventWithProof? = nil
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try decoder.decodeSingularMessageField(value: &_storage._validatorChangeEvents)
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._validatorChangeEvents {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      }
  ...
  static func ==(lhs: Types_UpdateToLatestLedgerResponse, rhs: Types_UpdateToLatestLedgerResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._validatorChangeEvents != rhs_storage._validatorChangeEvents {return false}
