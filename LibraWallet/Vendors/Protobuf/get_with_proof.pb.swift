...
struct Types_UpdateToLatestLedgerResponse {
  ...
  mutating func clearLedgerInfoWithSigs() {_uniqueStorage()._ledgerInfoWithSigs = nil}
  ...
  var validatorChangeProof: Types_ValidatorChangeProof {
    get {return _storage._validatorChangeProof ?? Types_ValidatorChangeProof()}
    set {_uniqueStorage()._validatorChangeProof = newValue}
  }
  /// Returns true if `validatorChangeProof` has been explicitly set.
  var hasValidatorChangeProof: Bool {return _storage._validatorChangeProof != nil}
  /// Clears the value of `validatorChangeProof`. Subsequent reads from it will return its default value.
  mutating func clearValidatorChangeProof() {_uniqueStorage()._validatorChangeProof = nil}
  ...
  mutating func clearLedgerConsistencyProof() {_uniqueStorage()._ledgerConsistencyProof = nil}
...
struct Types_GetAccountStateResponse {
  ...
  mutating func clearAccountStateWithProof() {_uniqueStorage()._accountStateWithProof = nil}
...
struct Types_GetAccountTransactionBySequenceNumberResponse {
  ...
  var transactionWithProof: Types_TransactionWithProof {
    get {return _storage._transactionWithProof ?? Types_TransactionWithProof()}
    set {_uniqueStorage()._transactionWithProof = newValue}
  }
  /// Returns true if `transactionWithProof` has been explicitly set.
  var hasTransactionWithProof: Bool {return _storage._transactionWithProof != nil}
  /// Clears the value of `transactionWithProof`. Subsequent reads from it will return its default value.
  mutating func clearTransactionWithProof() {_uniqueStorage()._transactionWithProof = nil}
  ...
  mutating func clearProofOfCurrentSequenceNumber() {_uniqueStorage()._proofOfCurrentSequenceNumber = nil}
...
struct Types_GetEventsByEventAccessPathResponse {
  ...
  mutating func clearProofOfLatestEvent() {_uniqueStorage()._proofOfLatestEvent = nil}
...
extension Types_UpdateToLatestLedgerRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Types_UpdateToLatestLedgerRequest, rhs: Types_UpdateToLatestLedgerRequest) -> Bool {
    if lhs.clientKnownVersion != rhs.clientKnownVersion {return false}
    if lhs.requestedItems != rhs.requestedItems {return false}
...
extension Types_RequestItem: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Types_RequestItem, rhs: Types_RequestItem) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._requestedItems != rhs_storage._requestedItems {return false}
        return true
      }
...
extension Types_UpdateToLatestLedgerResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .standard(proto: "validator_change_proof"),
  ...
  fileprivate class _StorageClass {
    ...
    var _validatorChangeProof: Types_ValidatorChangeProof? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _validatorChangeProof = source._validatorChangeProof
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try decoder.decodeSingularMessageField(value: &_storage._validatorChangeProof)
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._validatorChangeProof {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      }
  ...
  static func ==(lhs: Types_UpdateToLatestLedgerResponse, rhs: Types_UpdateToLatestLedgerResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._responseItems != rhs_storage._responseItems {return false}
        if _storage._ledgerInfoWithSigs != rhs_storage._ledgerInfoWithSigs {return false}
        if _storage._validatorChangeProof != rhs_storage._validatorChangeProof {return false}
        if _storage._ledgerConsistencyProof != rhs_storage._ledgerConsistencyProof {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Types_ResponseItem: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Types_ResponseItem, rhs: Types_ResponseItem) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Types_GetAccountStateRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Types_GetAccountStateRequest, rhs: Types_GetAccountStateRequest) -> Bool {
...
extension Types_GetAccountStateResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Types_GetAccountStateResponse, rhs: Types_GetAccountStateResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._accountStateWithProof != rhs_storage._accountStateWithProof {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Types_GetAccountTransactionBySequenceNumberRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Types_GetAccountTransactionBySequenceNumberRequest, rhs: Types_GetAccountTransactionBySequenceNumberRequest) -> Bool {
...
extension Types_GetAccountTransactionBySequenceNumberResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    2: .standard(proto: "transaction_with_proof"),
    3: .standard(proto: "proof_of_current_sequence_number"),
  ]

  fileprivate class _StorageClass {
    var _transactionWithProof: Types_TransactionWithProof? = nil
    ...
    init(copying source: _StorageClass) {
      _transactionWithProof = source._transactionWithProof
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 2: try decoder.decodeSingularMessageField(value: &_storage._transactionWithProof)
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      if let v = _storage._transactionWithProof {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
      }
  ...
  static func ==(lhs: Types_GetAccountTransactionBySequenceNumberResponse, rhs: Types_GetAccountTransactionBySequenceNumberResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._transactionWithProof != rhs_storage._transactionWithProof {return false}
        if _storage._proofOfCurrentSequenceNumber != rhs_storage._proofOfCurrentSequenceNumber {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Types_GetEventsByEventAccessPathRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Types_GetEventsByEventAccessPathRequest, rhs: Types_GetEventsByEventAccessPathRequest) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._accessPath != rhs_storage._accessPath {return false}
        if _storage._startEventSeqNum != rhs_storage._startEventSeqNum {return false}
        if _storage._ascending != rhs_storage._ascending {return false}
...
extension Types_GetEventsByEventAccessPathResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Types_GetEventsByEventAccessPathResponse, rhs: Types_GetEventsByEventAccessPathResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._eventsWithProof != rhs_storage._eventsWithProof {return false}
        if _storage._proofOfLatestEvent != rhs_storage._proofOfLatestEvent {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Types_GetTransactionsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Types_GetTransactionsRequest, rhs: Types_GetTransactionsRequest) -> Bool {
...
extension Types_GetTransactionsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Types_GetTransactionsResponse, rhs: Types_GetTransactionsResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
