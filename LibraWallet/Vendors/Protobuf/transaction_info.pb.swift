...
struct Types_TransactionInfo {
  ...
  var signedTransactionHash: Data = SwiftProtobuf.Internal.emptyData
...
extension Types_TransactionInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "signed_transaction_hash"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularBytesField(value: &self.signedTransactionHash)
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.signedTransactionHash.isEmpty {
      try visitor.visitSingularBytesField(value: self.signedTransactionHash, fieldNumber: 1)
    }
  ...
  func _protobuf_generated_isEqualTo(other: Types_TransactionInfo) -> Bool {
    if self.signedTransactionHash != other.signedTransactionHash {return false}
