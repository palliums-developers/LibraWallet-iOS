...
import UIKit
import CryptoSwift
@available(swift, deprecated: 13, message: "use `` instead")
...
//        
//        let script = ViolasTransactionScript.init(code: Data.init(hex: libraProgramCode),
...
extension ViolasTransaction {
    // 兑换币
//    public init(sendAddress: String, amount: Double, fee: Double, sequenceNumber: UInt64, code: Data, receiveTokenAddress: String, exchangeAmount: Double, tokenIndex: String) {
//
//        let argument0 = ViolasTransactionArgument.init(code: .U64, value: tokenIndex)
//
...
//        let argument2 = ViolasTransactionArgument.init(code: .U64, value: "\(Int(amount * 1000000))")
//
//        let data = "{\"type\":\"sub_ex\",\"tokenid\":\"\(receiveTokenAddress)\",\"amount\":\(Int(exchangeAmount * 1000000)),\"fee\":0,\"exp\":1000}".data(using: .utf8)!
//
...
//    }
    // 取消订单
//    public init(sendAddress: String, fee: Double, sequenceNumber: UInt64, code: Data, version: String, tokenIndex: String) {
//
//        let argument0 = ViolasTransactionArgument.init(code: .U64, value: tokenIndex)
//        let argument1 = ViolasTransactionArgument.init(code: .Address, value: MarketAddress)
