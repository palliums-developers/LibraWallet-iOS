//
//  DepositQuestionTableViewHeaderView.swift
//  LibraWallet
//
...
import UIKit
protocol DepositQuestionTableViewHeaderViewDelegate: NSObjectProtocol {
    func showQuestions(header: DepositQuestionTableViewHeaderView)
}
class DepositQuestionTableViewHeaderView: UITableViewHeaderFooterView {
    weak var delegate: DepositQuestionTableViewHeaderViewDelegate?
    ...
    deinit {
        print("DepositQuestionTableViewHeaderView销毁了")
    }
    //pragma MARK: 布局
    ...
    lazy var itemTitleLabel: UILabel = {
        ...
        label.text = localLanguage(keyString: "wallet_bank_deposit_question_title")
        return label
    }()
