//
//  PrivateLegalViewController.swift
//  SSO
//
...
import UIKit
import WebKit
class PrivateLegalViewController: BaseViewController {
    ...
    //子View
    private lazy var detailView : PrivateLegalView = {
        let view = PrivateLegalView.init()
        view.webView.navigationDelegate = self
        return view
    }()
    var needDismissViewController: Bool?
    deinit {
        print("PrivateLegalViewController销毁了")
    }
}
